...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <section id="intro" class="intro">
		...
		<div class="slogan">
			<h2>ESTA É A PÁGINA <span class="text_color">PRODUTOS</span> </h2>
			<h4>CLIQUE NO BOTÃO ABAIXO PARA IR ATÉ O CONTEÚDO</h4>
		</div>
		<div class="page-scroll">
			<a href="#produtos" class="btn btn-circle">
	...
	<!-- Section: produtos -->
    <section id="produtos" class="home-section text-center">
                ...
                <div class="col-lg-12">
                    <div class="boxed-grey">
                        ...
                        <div class="alert alert-success">
                            Dados enviados com sucesso, abaixo seguem os dados que você enviou: <br /><br />
