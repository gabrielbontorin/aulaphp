...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <section id="intro" class="intro">
		...
		<div class="page-scroll">
			<a href="#empresa" class="btn btn-circle">
	...
	<!-- Section: empresa -->
    <section id="empresa" class="home-section text-center">
	...
	<!-- Section: produtos -->
    <section id="produtos" class="home-section text-center bg-gray">
    ...
    <!-- Section: serviços -->
    <section id="servicos" class="home-section text-center">
